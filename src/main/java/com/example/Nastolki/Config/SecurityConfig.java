    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/bord/add/new_game").hasAnyRole("ADMIN")
                        .requestMatchers("/bord/all").hasAnyRole("ADMIN")
                        .requestMatchers("/bordgame/add/once").hasAnyRole("ADMIN")
